    ...
    <>
        <footer>
         ...
         <div className='footer-div'>
            <a style={style} href='https://tinyurl.com/yr4q7d95/speak?speak=Hello world!'> Musaif</a>	Created &copy;{differentDate} Days Ago, Now &copy;{currentdate.format('YYYY-MM-DD')}
         </div>
    </>
  )
}
